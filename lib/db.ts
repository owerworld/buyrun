...
const SCHEMA = [
  ...
  // Konum: yol tarifi koordinatla açılır, Google yer kimliği işletmenin kendisini gösterir
  ...
  `ALTER TABLE events ADD COLUMN IF NOT EXISTS place_id TEXT NOT NULL DEFAULT ''`,
  `ALTER TABLE events ADD COLUMN IF NOT EXISTS directions TEXT NOT NULL DEFAULT ''`,
